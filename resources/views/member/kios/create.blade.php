...
@section('konten')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-4">
                    <h5 class="card-header">Tambah Kios</h5>
                    <div class="card-body">
                        ...
                        <form action="{{ route('kios.store') }}" method="POST" enctype="multipart/form-data" id="my-form">
                            @csrf
...
@push('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\kios\KiosCreateRequest', '#my-form') !!}
@endpush
