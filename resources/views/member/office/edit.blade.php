                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <input type="text" name="latitude" class="form-control"
                                                placeholder="Latitude" value="{{ $office->latitude }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" name="longitude" class="form-control"
                                                placeholder="Longitude" value="{{ $office->longitude }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Office\OfficeUpdateRequest', '#my-form') !!}
@endpush
